      ...
      <div className="w-[80%] lg:w-[50%] py-20 mx-auto">
        ...
        <div className="mt-4 max-sm:w-fit flex max-sm:flex-col sm:items-center">
          ...
          <div className="sm:ml-6 max-sm:mt-4 max-sm:w-fit flex">
            ...
            <a aria-label="Click to check out my resume" className="ml-4 web_links hover:shadow-xl hover:shadow-purple-700" target="_blank" href="https://drive.google.com/file/d/1Ezxp--gRpHMIQ4cm0Zqd9kGHLfPFujFK/view?usp=sharing">
              <IoLink size={30} />
            </a>
          </div>
        </div>
